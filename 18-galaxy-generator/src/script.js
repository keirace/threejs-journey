...
parameters.insideColor = "#f0cc99";
parameters.outsideColor = "#65a0b3";
...
const generateGalaxy = () => {
	...
	for (let i = 0; i < parameters.count; i++) {
		...
		// if (i < 20) {
		// 	console.log(i, branchAngle, spinAngle, randomX, randomY, randomZ);
		// }
...
const tick = () => {
    ...
    galaxy.rotation.y = elapsedTime * parameters.speed;
