...
window.addEventListener("click", () => {
	if (currentIntersect) {
		console.log("click on object", objectsToTest.findIndex((object) => object === currentIntersect.object) + 1);
	}
});
...
const tick = () => {
	...
	objectsToTest.map((object) => object.material.color.set("#ff0000"));
	...
	if (model) {
		const modelIntersects = raycaster.intersectObject(model, true); // true to check children
