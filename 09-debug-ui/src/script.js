...
// Three.js applies some color management to optimise the rendering resulting in a different color than the one we set
...
// gui.add(geometry, 'widthSegments') // this will not work as widthSegments is used to generate the geometry only once
